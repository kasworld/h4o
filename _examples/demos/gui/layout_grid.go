...
func (t *GuiLayoutGrid) Start(a *app.App) {
	...
	t.menu.Subscribe(eventtype.OnMouseDownOut, func(evname eventtype.EventType, ev interface{}) {
		t.menu.SetVisible(false)
	})
	t.menu.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) {
	...
	b1.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) {
		...
		child.Subscribe(eventtype.OnMouseDown, func(evname eventtype.EventType, ev interface{}) {
	...
	b2.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) {
	...
	t.sw.SetText("width")
	t.sw.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
	...
	t.sh.SetText("height")
	t.sh.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
	...
	t.ddcs.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		sel := t.ddcs.Selected()
		v := sel.UserData().(int)
		if v != 0 {
			if t.colspan == nil {
	...
	dd1.Add(dd1o4)
	dd1.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		sel := dd1.Selected()
	...
	dd2.Add(dd2o4)
	dd2.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		sel := dd2.Selected()

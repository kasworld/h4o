...
func (t *GuiPanel) Start(a *app.App) {
	...
	p3Event := func(name eventtype.EventType, ev interface{}) { log.Debug("Parent:%v", name) }
	t.p3.Subscribe(eventtype.OnCursor, p3Event)
	t.p3.Subscribe(eventtype.OnCursorEnter, p3Event)
	t.p3.Subscribe(eventtype.OnCursorLeave, p3Event)
	t.p3.Subscribe(eventtype.OnMouseDown, p3Event)
	t.p3.Subscribe(eventtype.OnMouseUp, p3Event)
	...
	c.SetBorders(4, 4, 4, 4)
	t.p3.Add(c)
	c2Event := func(name eventtype.EventType, ev interface{}) { log.Debug("Child 2:%v", name) }
	c.Subscribe(eventtype.OnCursor, c2Event)
	c.Subscribe(eventtype.OnCursorEnter, c2Event)
	c.Subscribe(eventtype.OnCursorLeave, c2Event)
	c.Subscribe(eventtype.OnMouseDown, c2Event)
	c.Subscribe(eventtype.OnMouseUp, c2Event)
...
func (t *GuiPanel) onKey(evname eventtype.EventType, ev interface{}) {

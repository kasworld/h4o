...
func (t *GuiButton) Start(a *app.App) {
	...
	b1.Subscribe(eventtype.OnClick, func(name eventtype.EventType, ev interface{}) {
	...
	b2.Subscribe(eventtype.OnClick, func(name eventtype.EventType, ev interface{}) {
	...
	b3.Subscribe(eventtype.OnClick, func(name eventtype.EventType, ev interface{}) {
	...
	b4.Subscribe(eventtype.OnClick, func(name eventtype.EventType, ev interface{}) {
	...
	b5.SetStyles(&styles)
	b5.Subscribe(eventtype.OnClick, func(name eventtype.EventType, ev interface{}) {
	...
	b6.Subscribe(eventtype.OnClick, func(name eventtype.EventType, ev interface{}) {
		log.Info("button 6 OnClick")
	})
	b6.Subscribe(eventtype.OnEnable, func(name eventtype.EventType, ev interface{}) {
	...
	b7.Subscribe(eventtype.OnClick, func(name eventtype.EventType, ev interface{}) {

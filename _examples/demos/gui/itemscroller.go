...
func (t *GuiScroller) Start(a *app.App) {
	...
	a.DemoPanel().Add(b21)
	b21.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) {
		l := gui.NewLabel(" ")
	...
	b22.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) {
		if s2.Len() > 0 {
			s2.RemoveAt(0)
		}
	})

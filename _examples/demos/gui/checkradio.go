...
func (t *CheckRadio) Start(a *app.App) {
	...
	cb2.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
	...
	cb3.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
	...
	cb4.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
	...
	cb5.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
	...
	rb1.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
	...
	rb2.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
	...
	rb3.SetGroup("group1")
	rb3.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
	...
	rb4.SetGroup("group1")
	rb4.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
	...
	rb5.SetGroup("group1")
	rb5.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {

...
func (t *Scroller) Start(a *app.App) {
	...
	scrollMode1.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
	...
	scrollMode2.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
		if scrollMode2.Value() == true {
			log.Info("ScrollVertical")
	...
	scrollMode3.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
		if scrollMode3.Value() == true {
			log.Info("ScrollHorizontal")
	...
	scrollMode4.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
	...
	interlocking1.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
		if interlocking1.Value() == true {
			log.Info("ScrollbarInterlockingVertical")
	...
	interlocking2.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
		if interlocking2.Value() == true {
			log.Info("ScrollbarInterlockingHorizontal")
	...
	interlocking3.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
		if interlocking3.Value() == true {
			log.Info("ScrollbarInterlockingNone")
	...
	cb1.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
		log.Info("CornerCovered Checkbox OnChange: %v", cb1.Value())
	...
	v1.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
		log.Info("Left/Right Checkbox OnChange: %v", v1.Value())
		if v1.Value() == true {
	...
	v2.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
		log.Info("Vertical OverlapContent Checkbox OnChange: %v", v2.Value())
	...
	v3.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
		log.Info("Vertical AutoSizeButton Checkbox OnChange: %v", v3.Value())
	...
	vb.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
	...
	h1.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
		log.Info("Top/Bottom Checkbox OnChange: %v", h1.Value())
		if h1.Value() == true {
	...
	h2.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
		log.Info("Horizontal OverlapContent Checkbox OnChange: %v", h2.Value())
	...
	h3.Subscribe(eventtype.OnChange, func(name eventtype.EventType, ev interface{}) {
		log.Info("Horizontal AutoSizeButton Checkbox OnChange: %v", h3.Value())
	...
	hb.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		//log.Info("Slider 1 OnChange: %v", s1.Value())
	...
	cw.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		//log.Info("Slider 1 OnChange: %v", s1.Value())
	...
	ch.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		//log.Info("Slider 1 OnChange: %v", s1.Value())

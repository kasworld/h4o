...
func (t *GuiLayoutHBox) Start(a *app.App) {
	...
	p1c1.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		if p1c1.Value() {
	...
	p1c2.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		if p1c2.Value() {
	...
	p1c3.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		if p1c3.Value() {
	...
	p1c4.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		if p1c4.Value() {
	...
	p1c5.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		if p1c5.Value() {
	...
	p1c6.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		if p1c6.Value() {
	...
	p1c7.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		if p1c7.Value() {
	...
	p1c8.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		if p1c8.Value() {
	...
	cbexp.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		if cbexp.Value() {
			params.Expand = 1
		} else {
			params.Expand = 0

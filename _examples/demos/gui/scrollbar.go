...
func (t *GuiScrollBar) Start(a *app.App) {
	...
	a.DemoPanel().Add(l1)
	sb1.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
	...
	a.DemoPanel().Add(l2)
	sb2.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
	...
	a.DemoPanel().Add(l3)
	sb3.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
	...
	a.DemoPanel().Add(l4)
	sb4.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {

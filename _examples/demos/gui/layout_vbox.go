...
func (t *GuiLayoutVBox) Start(a *app.App) {
	...
	rb.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) {
	...
	p1b1.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) {
	...
	p1b2.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) {
		if len(p1.Children()) > 0 {
			p1.Remove(p1.Children()[0].(gui.PanelI))
		}
	})
	...
	cb2.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) { bl1.SetAutoWidth(cb2.Value()) })
	cb2.SetValue(true)
	a.DemoPanel().Add(cb2)
	// Top
	...
	p1c1.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) { bl1.SetAlignV(gui.AlignTop) })
	...
	p1c2.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) { bl1.SetAlignV(gui.AlignCenter) })
	...
	p1c3.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) { bl1.SetAlignV(gui.AlignBottom) })
	...
	p1c4.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) { bl1.SetAlignV(gui.AlignHeight) })
	...
	p1c5.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) { params.AlignH = gui.AlignLeft })
	...
	p1c6.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) { params.AlignH = gui.AlignCenter })
	...
	p1c7.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) { params.AlignH = gui.AlignRight })
	...
	p1c8.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) { params.AlignH = gui.AlignWidth })
	...
	p1c9.Subscribe(eventtype.OnClick, func(evname eventtype.EventType, ev interface{}) {
		if p1c9.Value() {
			params.Expand = 1
		} else {
			params.Expand = 0

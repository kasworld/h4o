...
func (t *GuiPanelChildren) Start(a *app.App) {
	...
	a.SubscribeID(eventtype.OnKeyDown, a, t.onKey)
	a.SubscribeID(eventtype.OnKeyRepeat, a, t.onKey)
}

func (t *GuiPanelChildren) onKey(evname eventtype.EventType, ev interface{}) {

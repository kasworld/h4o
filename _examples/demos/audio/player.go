...
func NewPlayerControl(a *app.App, filename string) (*PlayerControl, error) {
	...
	bPlay.Subscribe(eventtype.OnClick, func(name eventtype.EventType, ev interface{}) {
		pc.player.Play()
	})
	bPanel.Add(bPlay)
	...
	bPause.Subscribe(eventtype.OnClick, func(name eventtype.EventType, ev interface{}) {
		pc.player.Pause()
	})
	bPanel.Add(bPause)
	...
	bStop.Subscribe(eventtype.OnClick, func(name eventtype.EventType, ev interface{}) {
		pc.player.Stop()
		pc.UpdateTime()
	})
	bPanel.Add(bStop)
	...
	pc.sliderGain.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
	...
	pc.sliderPitch.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {

...
func (t *AudioDirection) Start(a *app.App) {
	...
	cb3.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		t.pc3.Toggle()
	})
	cb4 := g1.AddCheckBox("bomb2").SetValue(true)
	cb4.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		t.pc4.Toggle()
	})
	cb5 := g1.AddCheckBox("tone_440hz").SetValue(true)
	cb5.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		t.pc5.Toggle()
	})
	cb6 := g1.AddCheckBox("tone_1khz").SetValue(true)
	cb6.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
		t.pc6.Toggle()
	})

	g2 := a.ControlFolder().AddGroup("Sound Cone")
	g1s1 := g2.AddSlider("Outer Cone:", 360, t.pc1.player.OuterCone())
	g1s1.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
	...
	g1s2.Subscribe(eventtype.OnChange, func(evname eventtype.EventType, ev interface{}) {
